        ...
        <div className="flex-none flex flex-wrap items-center justify-between gap-4 mb-4 bg-[#111111] px-4 py-3 -mx-4 -mt-4 pr-8">
            ...
            <div className="flex flex-wrap items-center gap-2 relative">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <RotaryKnob compact disabled={isDryMode} dragLockRef={isDraggingKnobRef} label="DRY GAIN" value={dryGain} min={0} max={10} step={0.5} unit="dB" color="gold" onChange={(v) => handleGainChange('dryGain', v)} onDragStateChange={handleNormalDragState} tooltipKey="dryGain" onHover={handleKnobEnter} onLeave={handleKnobLeave} />
                </div>
            </div>
        </div >
    );
