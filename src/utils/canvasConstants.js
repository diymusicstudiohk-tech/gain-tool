...
export const GRID_DB_MIN = -60;
export const GRID_DB_MAX = -5;
...
export const TOOLTIP_HEIGHT = 24;
export const TOOLTIP_PAD_X = 8;
export const TOOLTIP_TEXT_BASELINE = 16;
export const TOOLTIP_EDGE_CLAMP = 2;

// --- Waveform Legend ---
export const LEGEND_HEIGHT = 28;
export const LEGEND_PAD_X = 10;
export const LEGEND_TEXT_BASELINE = 18;
export const LEGEND_BG = 'rgba(0, 0, 0, 0.75)';
